...
│   ├── cliChat.test.ts    # Unit tests: prompt-message conversion
...
Press **Tab** to complete the command name, and Tab again to complete the
document argument.
...
- `tests/cliChat.test.ts` — prompt‑message → Anthropic conversion.
